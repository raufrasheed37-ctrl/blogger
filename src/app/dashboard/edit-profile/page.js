...
followersList: currentUser.privacy?.followersList || "everyone",
subscriptionsList: currentUser.privacy?.subscriptionsList || "everyone",

bio: currentUser.privacy?.bio || "everyone",
occupation: currentUser.privacy?.occupation || "everyone",
company: currentUser.privacy?.company || "everyone",

twitter: currentUser.privacy?.twitter || "everyone",
instagram: currentUser.privacy?.instagram || "everyone",
facebook: currentUser.privacy?.facebook || "everyone",
linkedin: currentUser.privacy?.linkedin || "everyone",
github: currentUser.privacy?.github || "everyone",
youtube: currentUser.privacy?.youtube || "everyone",
},
});
...
if (selectedPhoto) {
  ...
  followersList: updatedUser.privacy?.followersList || "everyone",
  subscriptionsList: updatedUser.privacy?.subscriptionsList || "everyone",

  bio: updatedUser.privacy?.bio || "everyone",
  occupation: updatedUser.privacy?.occupation || "everyone",
  company: updatedUser.privacy?.company || "everyone",

  twitter: updatedUser.privacy?.twitter || "everyone",
  instagram: updatedUser.privacy?.instagram || "everyone",
  facebook: updatedUser.privacy?.facebook || "everyone",
  linkedin: updatedUser.privacy?.linkedin || "everyone",
  github: updatedUser.privacy?.github || "everyone",
  youtube: updatedUser.privacy?.youtube || "everyone",
},
      });
